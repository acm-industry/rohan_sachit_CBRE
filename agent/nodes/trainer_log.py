...
def build_ai_prediction(
    *,
    ...
    clarification_reasons: Optional[List[str]] = None,
    ...
    validator_reason_list = validator_reasons or []
    pred: Dict[str, Any] = {
        "category": category,
        ...
        # Keep both names: `validator_reasons` is the runtime term; `hitl_reasons`
        # is the design-doc/training-corpus term reviewers expect to inspect.
        "reasoning": classification_reasoning,
        "classification_reasoning": classification_reasoning,
        "validator_reasons": validator_reason_list,
        "hitl_reasons": validator_reason_list,
        "risk_reasons": risk_reasons or [],
        "clarification_reasons": clarification_reasons or [],
