...
// "voice" + "voice_response" + "transcript" are emitted by the backend's
// voice-mode path: one transcript per turn, one voice with the bundled
// turns payload, one voice_response with TTS audio at end-of-pipeline.
export type Stage =
  | PipelineStage
  | "trainer_log"
  | "voice"
